...
The 'novacart_elt' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] novacart_elt_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/novacart_elt.job.yml). The schedule
